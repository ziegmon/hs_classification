...
@app.route('/clear-and-restart-bulk', methods=['POST'])
def clear_and_restart_bulk():
    session.pop('current_footwear_batch_id', None)
    return redirect(url_for('footwear_bulk_classification'))
